...
public class InputController : MonoBehaviour
{
    ...
    private Dictionary<int, Vector2> touchIdTopressedPosition;
...
#if UNITY_EDITOR
        touchIdTopressedPosition = new Dictionary<int, Vector2>(1);
#elif UNITY_ANDROID
        touchIdTopressedPosition = new Dictionary<int, Vector2>(5);
#endif
    }
